...
function PrivacyPolicy() {
  return (
    <div className="content">
      ...
      <p>
        SSAFY 6기 a205팀 SSAFY24 (이하 &ldquo;SSAFY24&rdquo;)가 만들고 서비스
        하는 Vote24(&lsquo;http://i6a205.p.ssafy.io:3000/&lsquo;, 이하
        &ldquo;서비스&rdquo;)은 다음의 목적을 위하여 개인정보를 처리하고 있으며,
      ...
      <ol>
        ...
        <li>
          ...
          진행하고 있는 경우 해당 회원이 Vote24 이용자임을 홍보하기 위한 용도
        </li>
      </ol>
      <p>&nbsp;</p>
      <p>
      ...
      <ol>
        <li>
          SSAFY24는 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보
        ...
        <li>
          ...
          SSAFY24는 아래와 같이 관계법령에서 정한 일정한 기간 동안 회원정보를
          보관합니다.
        </li>
        <ol>
          <li>
      ...
      <p>
        SSAFY24는 정보주체의 별도 동의, 법률의 특별한 규정 등 개인정보 보호법
      ...
      <ol>
        <li>
          SSAFY24는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보
          처리업무를 위탁하고 있습니다. Nice 정보통신: 신용카드 결제승인 및
          매입업무 대행, 결제확인용 생년월일 및 법인사업자등록번호, 결제연락용
          이메일주소
        </li>
        <li>
          SSAFY24는 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무
      ...
      <ol>
        <li>
          ...
          같은 권리를 행사할 수 있으며, 정보주체는 Vote24에 대해 언제든지 다음
        ...
        <li>
          제1항에 따른 권리 행사는 SSAFY24에 대해 서면, 전자우편, 고객지원 등을
          통하여 하실 수 있으며 SSAFY24는 이에 대해 지체없이 조치하겠습니다.
        </li>
        <li>
          이용자가 개인정보의 오류 등에 대한 정정 또는 삭제를 요구한 경우에는
          SSAFY24는 정정 또는 삭제를 완료할 때까지 당해 개인정보를 이용하거나
          제공하지 않습니다.
        </li>
        <li>
        ...
        <li>
          이용자는 정보통신망법, 개인정보보호법 등 관계법령을 위반하여 SSAFY24가
      ...
      <p>SSAFY24는 다음의 개인정보 항목들을 처리하고 있습니다.</p>
      <ol>
        <li>
          &lt;회원가입&gt;
          <br />
      ...
      <ol>
        <li>
          SSAFY24는 제공하는 서비스를 통해 이용자의 정보를 저장하고 수시로
          찾아내는 쿠키(cookie)를 설치하고 운용할 수도 있습니다. SSAFY24가
          쿠키(cookie)를 통해 수집한 고객의 정보는 다음의 목적을 위해 사용될 수
          있습니다.
        </li>
        <ol>
      ...
      <p>
        SSAFY24는 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당
      ...
      <p>
        SSAFY24는 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한
      ...
      <ol>
        ...
        <li>
          해킹 등에 대비한 기술적 대책
          <br />
          Vote24는 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을
      ...
      <ol>
        <li>
          SSAFY24는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
          처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이
          개인정보 보호책임자를 지정하고 있습니다.
          <br />- 개인정보 보호책임자 <br />- 성명 : 박지후
          <br />- 연락처 : guruboy@snu.ac.kr
        </li>
        <li>
          정보주체께서는 SSAFY24의 서비스(또는 사업)을 이용하시면서 발생한 모든
          개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보
          보호책임자 및 담당부서로 문의하실 수 있습니다. SSAFY24는 정보주체의
      ...
      <ol>
        <li>
          SSAFY24는 이 개인정보 처리방침의 내용과 상호 및 대표자 성명, 영업소
          소재지 주소, 전자우편주소, 사업자등록번호, 통신판매업 신고번호,
          개인정보관리책임자등을 연결화면을 통하여 게시합니다.
        </li>
        <li>
          SSAFY24는 회원가입시 이용자에게 회원가입 행위가 개인정보 처리방침에
          동의하는 행위임을 알리고 개인정보 처리방침의 내용을 연결화면을 통하여
          볼 수 있도록 합니다.
        </li>
        <li>
          SSAFY24는 관련 법을 위배하지 않는 범위에서 이 개인정보 처리방침을
          개정할 수 있습니다.
        </li>
        <li>
          SSAFY24가 개인정보 처리방침을 개정할 경우에는 개정사유를 명시하여 현행
        ...
        <li>
          SSAFY24가 개인정보 처리방침을 개정할 경우에는 제1항에 의한 방법으로
          회원들에게 개정 사항을 알리며 개정 개인정보 처리방침 적용 7일 이전
          부터 적용일자 전일 까지 이의 의사를 SSAFY24측에 표명하지 않으면 개정
